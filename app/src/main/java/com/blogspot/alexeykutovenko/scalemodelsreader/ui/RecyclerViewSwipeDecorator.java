...
/**
 * A simple utility class to add a background and/or an icon while swiping a RecyclerView item
 * left or right. Based on https://github.com/xabaras/RecyclerViewSwipeDecorator
 */
